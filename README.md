...
LexAI is an **Agentic AI-powered legal assistant** that helps users understand complex legal documents in seconds.
It combines **multi-agent reasoning**, **RAG-based Q&A**, and a **clean frontend experience** to make legal information accessible to everyone.
